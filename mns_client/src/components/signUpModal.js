		...
		if (formData.contact.phone !== "") {
			...
			fetch(`http://localhost:3000/users/phone/${formData.contact.phone}`)
				...
				.then((data) => {
					if (data === "exists") {
						errorFlag = false;
						document.getElementById("phone_num_exists").style.display = "inline";
						...
						<Col>
							<Form.Group className="mb-3">
								...
								<Form.Text className="error" id="phone_num_exists">
									Please enter a different Phone No. This already exists in the system.
								</Form.Text>
							</Form.Group>
						</Col>
						<Col>
						...
						<Col>
							<Form.Group className="mb-3">
								...
								<Form.Text className="error" id="username_exists">
									Please enter a different username. This already exists in the system.
								</Form.Text>
