...
//   const classes = useStyles();
  ...
  return (
    ...
    <Grid container spacing={2}>
      ...
      <Typography variant="h5">{property.property_type} hosted by {property.host_name}</Typography>
        ...
        <Typography variant="body1" gutterBottom>
          {property.max_guests} Guests | {property.bed_count} Beds | {property.bath_count} Baths
        </Typography>
        <Divider/>
          <CardContent>
        ...
        <Divider/>
          <CardContent>
            ...
            <li> 
              <Typography variant="body2" gutterBottom>Swimming Pool</Typography>
              </li>
              }
            
            {property.amenities.sun_lounger && 
                <li>
              <Typography variant="body2" gutterBottom>Sun Lounger</Typography>
              </li>
              }

            {property.amenities.garden && 
                <li>
              <Typography variant="body2" gutterBottom>Garden</Typography>
              </li>
              }

            {property.amenities.television && 
                <li>
              <Typography variant="body2" gutterBottom>Television</Typography>
              </li>
              }
    ...
    <CardContent>
      ...
      <Grid item alignItems="center" justifyContent='center' xs={12}>
      <Typography>Cleaning Fee : ${property.cost.cleaning_fee}</Typography>
      </Grid>
      <Grid item alignItems="center" justifyContent='center' xs={12}>
      <Typography>Deposit Amount : ${property.cost.deposit}</Typography>
      <br/>
      </Grid>
      
      <Grid item alignItems="center" justifyContent='center' xs={12}>
      <Divider variant='fullWidth' style={{height:2,backgroundColor:"darkgrey"}}/>
      <Typography variant='h5'>Total : ${property.cost.per_night+property.cost.cleaning_fee+property.cost.deposit}</Typography>
      </Grid>
      {/* <Grid item> */}
      </Grid>
      {/* </Grid> */}
